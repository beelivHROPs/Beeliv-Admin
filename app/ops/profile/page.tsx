...
const OPS_NAME = "Sample Operations Lead";
 ...
 * implemented). Name matches app/ops/layout.tsx's userName prop.
 */
      ...
      <div className="grid gap-4 sm:grid-cols-[1fr_auto]">
        <div className="rounded-lg border border-border bg-card p-5">
          <div className="grid gap-4 sm:grid-cols-2">
            <Field label="Full name" defaultValue={OPS_NAME} />
            <Field label="Phone number" defaultValue="+234 803 456 7890" />
          </div>
          <div className="mt-4">
            <Field label="Email address" defaultValue="operations@example.com" full />
          </div>
          <div className="mt-4">
            <Field label="Home address" defaultValue="5 Victoria Island, Lagos" full />
          </div>
        ...
        <div className="rounded-lg border border-border bg-card p-5 sm:w-64">
          <div className="flex items-center gap-3">
            <ProfileAvatarUpload name={OPS_NAME} />
            <div>
              <div className="text-sm font-semibold text-foreground">{OPS_NAME}</div>
              <div className="text-xs text-muted-foreground">Head of Operations · Beeliv-Wide</div>
            </div>
          </div>
        </div>
      </div>
