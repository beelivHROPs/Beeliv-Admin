 ...
 * implemented). Name matches app/hr/layout.tsx's userName prop.
 */
      ...
      <div className="grid gap-4 sm:grid-cols-[1fr_auto]">
        <div className="rounded-lg border border-border bg-card p-5">
          <div className="grid gap-4 sm:grid-cols-2">
            <Field label="Full name" defaultValue={HR_NAME} />
            <Field label="Phone number" defaultValue="+234 802 345 6789" />
          </div>
          <div className="mt-4">
            <Field label="Email address" defaultValue="ngozi.eze@example.com" full />
          </div>
          <div className="mt-4">
            <Field label="Home address" defaultValue="22 Marina Road, Lagos" full />
          </div>
        ...
        <div className="rounded-lg border border-border bg-card p-5 sm:w-64">
          <div className="flex items-center gap-3">
            <ProfileAvatarUpload name={HR_NAME} />
            <div>
              <div className="text-sm font-semibold text-foreground">{HR_NAME}</div>
              <div className="text-xs text-muted-foreground">Assigned HR · Sample Outlet 1</div>
            </div>
          </div>
        </div>
      </div>
